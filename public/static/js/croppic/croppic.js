...
(function ($,window, document) {
    ...
    Croppic = function (id, options) {
        ...
        that.options = {
            ...
            onError: null,
            cropZoomWidth:0,//裁剪区域宽度
            cropZoomHeight:0,//裁剪区域高度
    ...
    Croppic.prototype = {
        ...
        init: function () {
            ...
            if(that.options.cropZoomWidth>0){
                that.objW = that.options.cropZoomWidth;
            }else{
                that.objW = that.obj.width();
            }

            if(that.options.cropZoomHeight>0){
                that.objH = that.options.cropZoomHeight;
            }else{
                that.objH = that.obj.height();
            }
            //that.objW = 300;//that.obj.width();
            //that.objH = 300;//that.obj.height();
            // reset rotation
            ...
            console.log($.isEmptyObject(that.options.loadPicture));
        ...
        destroy:function(){
            ...
            if( !$.isEmptyObject( that.options.loadPicture ) ){that.imgUrl='';}
            if( !$.isEmptyObject( that.options.loadPicture ) ){that.options.loadPicture='';}
            that.obj.html('');
        },
