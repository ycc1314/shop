<?php /*a:2:{s:75:"/Users/seven/feisujie-master/shop/application/manage/view/pages/custom.html";i:1567760372;s:69:"/Users/seven/feisujie-master/shop/application/manage/view/layout.html";i:1567760372;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    <link rel="stylesheet" href="/static/lib/custom/css/style.css">
...
<script src="/static/lib/custom/js/sortable.min.js"></script>
<script src="/static/lib/custom/js/vuedraggable.min.js"></script>
<script src="/static/lib/custom/element/index.js"></script>

<script>
	var linkType = <?php echo $linkType; ?>;//跳转类型
	var pageCode = "<?php echo htmlentities($page_code); ?>";//页面编码
	var pageConfig = <?php echo $page_config; ?>;//页面默认数据
	var brandList = <?php echo $brandList; ?>;//品牌数据
	var catList = <?php echo $catList; ?>;//分类数据
	var default_banner = "/static/images/empty-banner.png";
	var default_img = "/static/images/empty.png";
	var saveUrl = "<?php echo url('Pages/saveCustom'); ?>";
	var imgWindowArr = [
		"/static/images/image-one-column.png",
		"/static/images/image-three-column.png",
		"/static/images/image-four-column.png",
		"/static/images/image-one-left.png"
	]
</script>
<div id="app">
	<home></home>
		...
		<div class="form-edit-wrapper">
			...
			<div class="center-container">
				<div class="model-title">
					<img src="/static/images/model-title.png">
				</div>
					...
					<div v-if="item.type === 'groupPurchase'" class="drag clearfix lay-goods slide group">
						...
						<div class="group-item" v-for="(goods,key) in item.value.list" :key="key">
							<div class="group-image">
								<img src="/static/images/empty-banner.png" alt="">
							</div>
							<div class="group-detail">
								...
								<span class="buy-icon">
									<img src="/static/images/ic-car.png" alt="">
								</span>
							</div>
						</div>
					</div>
					...
					<div v-if="item.type==='article'" class="drag lay-article">
						<div class="article-wrap clearfix" v-for="(article,key) in item.value.list">
							...
							<div class="article-img">
								<img :src="article.cover||'/static/images/empty-banner.png'" alt="">
							</div>
						</div>
					</div>
					<!-- 文章分类 -->
			...
			<el-form ref="form" label-width="100px" label-position="left">
					...
					<div>
						...
						<div class="pl25">
							<p class="layout-tip">优惠券数据请到 促销管理 - <a href="javascript:;"
									lay-href="<?php echo url('promotion/coupon'); ?>">优惠券列表</a>中管理
							</p>
						</div>
					</div>
				...
				<template v-if="selectWg.type=='goods'">
					<div>
						...
						<div class="pl25">
							<p class="layout-tip">商品数据请到 商品管理 - <a href="javascript:;" lay-href="<?php echo url('goods/index'); ?>">商品列表</a> 中管理
							</p>
						</div>
					</div>
				</template>
					...
					<div>
						...
						<div class="pl25">
							<p class="layout-tip">团购秒杀数据请到 促销管理 - <a href="javascript:;"
									lay-href="<?php echo url('promotion/group'); ?>">团购秒杀列表</a>中管理
							</p>
						</div>
					</div>
				</template>
					...
					<div>
						...
						<div class="pl25">
							<p class="layout-tip">拼团数据请到 促销管理 - <a href="javascript:;"
									lay-href="<?php echo url('pintuan/index'); ?>" >拼团列表</a>中管理
							</p>
						</div>
					</div>
				</template>
				...
				<template v-if="selectWg.type=='article'">
					<div>
						...
						<div class="pl25">
							<p class="layout-tip">文章数据请到 运营管理 - <a href="javascript:;" lay-href="<?php echo url('article/index'); ?>">文章列表</a> 中管理
							</p>
						</div>
				...
				<template v-if="selectWg.type=='notice'">
					...
					<div class="pl25">
						<p class="layout-tip">公告数据请到 运营管理 - <a href="javascript:;" lay-href="<?php echo url('notice/index'); ?>">公告列表</a> 中管理
						</p>
					</div>
				</template>
				<!-- 导航组-->
...
<script src="/static/lib/custom/js/main.js"></script>
</div>
</body>
</html>
